...
Calculates Gauss Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
```bash
python "Gauss Constant.py" -n 1000
```
